...
public class CompanyManagerJPanel extends javax.swing.JPanel {
    ...
    public CompanyManagerJPanel(JPanel userProcessContainer, UserAccount account, Business business ) {
    ...
    private void initComponents() {
        ...
        registerNew.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 310, 150, 40));
        ...
        jLabel2.setForeground(new java.awt.Color(85, 65, 119));
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Business decisions-bro.png"))); // NOI18N
        jLabel17.setPreferredSize(new java.awt.Dimension(400, 400));
        registerNew.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, 530, 370));

        add(registerNew, "card3");

        requestListing.setBackground(new java.awt.Color(255, 255, 255));
        requestListing.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        txtNumberOfShares.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 204, 204), new java.awt.Color(153, 153, 153)));
        txtNumberOfShares.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNumberOfSharesActionPerformed(evt);
            }
        });
        requestListing.add(txtNumberOfShares, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 194, 125, 29));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Enter Number of Shares:");
        requestListing.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 199, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel10.setText("Price Per Share:");
        requestListing.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 241, -1, -1));

        txtPricePerShare.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(204, 204, 204), new java.awt.Color(153, 153, 153)));
        requestListing.add(txtPricePerShare, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 241, 125, 29));
        ...
        requestListing.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(304, 328, 114, 40));
        ...
        requestListing.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1094, -1));

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Pie chart-amico.png"))); // NOI18N
        jLabel16.setPreferredSize(new java.awt.Dimension(400, 400));
        requestListing.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 90, 830, 370));
        ...
        InvestmentManager.add(jComboCompanyName, new org.netbeans.lib.awtextra.AbsoluteConstraints(203, 168, 120, -1));
        ...
        jLabel19.setForeground(new java.awt.Color(85, 65, 119));
        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel19.setText("Assigning Investment Manager");

        jButton6.setBackground(new java.awt.Color(85, 65, 119));
        ...
        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/forming team leadership-amico.png"))); // NOI18N
        jLabel15.setPreferredSize(new java.awt.Dimension(400, 400));
        InvestmentManager.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 320, 830, 370));
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Server status-rafiki.png"))); // NOI18N
        jLabel14.setPreferredSize(new java.awt.Dimension(400, 400));
        ...
        homepage.add(btnNewIM, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 240, 40));
        ...
        btnRegisterNewCom.setBorder(null);
        ...
        homepage.add(btnRegisterNewCom, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 200, 40));
        ...
        homepage.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 810, 138));
        ...
        homepage.add(btnRequestListing, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, -1, 40));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Next steps-rafiki.png"))); // NOI18N
        jLabel13.setPreferredSize(new java.awt.Dimension(400, 400));
        homepage.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 830, 370));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            if(this.business.getCompliance().getComplianceModerator().getCompanyByName(txtCompanyName.getText())!=null){
            ...
            else if(txtAsset.getText().isBlank()||txtLiab.getText().isBlank()||txtCompanyName.getText().isBlank())
            {
               ...
               return;
                ...
                company.setLiabilites(liab);
                company.setAssets(assets);
                company.setLicenseStatus("Pending");
                company.setLicenseRequestStatus("Not Initiated");
                company.setCapital(assets-liab);
                company.setBalance(assets-liab);
                company.setCompanyManager(manager);
                this.manager.getCompanyList().add(company);
                this.business.getCompliance().getComplianceModerator().getCompanyList().add(company);
    ...
    private void btnRequestListingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRequestListingActionPerformed
        ...
        Company selectedCompanyForListing = this.business.getCompliance().getComplianceModerator().getCompanyByName(selectedCompanyName);
       
        if(selectedCompanyForListing.getLicenseStatus().equals("Approved")){
            if(selectedCompanyForListing.getLicenseRequestStatus().equals("Approved")){
...
//        txtPricePerShare.setText(String.valueOf(selectedCompany.getCaptial()/numberOfShares));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         try{
            int numberOfShares = Integer.parseInt(txtNumberOfShares.getText());
            Double pricePerShare = selectedCompany.getCapital()/numberOfShares;
            ListingRequest listingRequest = new ListingRequest(this.selectedCompany, pricePerShare, numberOfShares);
            this.selectedCompany.setLicenseRequestStatus("Pending");
            for(ListingRequest listReq: this.business.getMarket().getStockMarket().getStockMarketModerator().getListingRequestList()){
                if(listReq.getCompany().getName().equals(selectedCompany.getName())){
                    this.business.getMarket().getStockMarket().getStockMarketModerator().getListingRequestList().remove(listReq);
                }
            }
            this.business.getMarket().getStockMarket().getStockMarketModerator().getListingRequestList().add(listingRequest);
            int requestCount =this.business.getMarket().getStockMarket().getStockMarketModerator().getRequestCount();
            listingRequest.setRequestId(requestCount);
            this.business.getMarket().getStockMarket().getStockMarketModerator().setRequestCount(requestCount+1);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        setComponent(homepage);
        txtNumberOfShares.setText("");
        txtPricePerShare.setText("");
...
//        try{
            Company selectedCompany = this.business.getCompliance().getComplianceModerator().getCompanyByName(String.valueOf(jComboCompanyName.getSelectedItem()));
            System.out.println(String.valueOf(tblApplications.getValueAt(tblApplications.getSelectedRow(), 0)));
            System.out.println("-----");
            for(InvestmentManager im : business.getCompliance().getComplianceModerator().getInvestmentManagers()){
                System.out.println(im.getName());
            }
            InvestmentManager applicant = this.business.getCompliance().getComplianceModerator().getInvestmentManagerByName(String.valueOf(tblApplications.getValueAt(tblApplications.getSelectedRow(), 0)));
...
//        }
    ...
    private void populateRegisterTable() {
       DefaultTableModel model = (DefaultTableModel) tableRegisterComp.getModel();
        ...
        for(Company company: this.manager.getCompanyList()){
            ...
            row[5]=company.getLicenseRequestStatus();
    ...
    private void populateJobRequestTable() {
        ...
        for(JobRequest jobRequest: selectedCompany.getJobRequest()){
            if(jobRequest.getAppliedManager().getAssignedCompany()==null){
                Object[] row= new Object[3];
                row[0]=jobRequest.getAppliedManager().getName();
