...
public class CommodityBrokerJPanel extends javax.swing.JPanel {
    ...
    Business business;
    UserAccount user;
    public CommodityBrokerJPanel(JPanel userProcessContainer, UserAccount account, Business business) {
        this.user=account;
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Consultative sales-bro.png"))); // NOI18N
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, 580, 400));
        ...
        jPanel2.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 218, 757, 149));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(279, 417, 164, 40));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setText("Sell Request:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(133, 184, -1, -1));
        ...
        jPanel2.add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(479, 417, 165, 40));
        ...
        jLabel4.setForeground(new java.awt.Color(85, 65, 119));
        ...
        jPanel2.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1482, -1));

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Auction-pana.png"))); // NOI18N
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 370, 230, 200));
        ...
        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 230, 735, 156));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Buy Request:");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(153, 201, -1, -1));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(299, 410, 175, 40));
        ...
        jPanel3.add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(525, 410, 175, 40));
        ...
        jLabel6.setForeground(new java.awt.Color(85, 65, 119));
        ...
        jPanel3.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1430, -1));

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assests/Partnership-bro.png"))); // NOI18N
        jPanel3.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 310, 420, 400));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        CommodityPurchaseRequest purchaseRequest = this.commodityBroker.getBuyRequestById(Integer.parseInt(String.valueOf(buyRequestTable.getValueAt(buyRequestTable.getSelectedRow(), 0))));
        CommodityHoldings holdingToAdd = new CommodityHoldings();
        Boolean addNewFlag =true;
        for(CommodityHoldings commodityHoldings:((Investor)purchaseRequest.getBuyer()).getCommodityHoldings()){
            if(commodityHoldings.getCommodity()==purchaseRequest.getCommodity()){
                holdingToAdd=commodityHoldings;
                addNewFlag=false;
            }
        }
        double price = ((holdingToAdd.getBuyingPrice()*holdingToAdd.getQuantity())+(purchaseRequest.getQuantity()*purchaseRequest.getCommodity().getCommodityPrice()))/(holdingToAdd.getQuantity()+purchaseRequest.getQuantity());
        holdingToAdd.setQuantity(holdingToAdd.getQuantity()+purchaseRequest.getQuantity());
        holdingToAdd.setBuyingPrice(price);
        if(addNewFlag){
            holdingToAdd.setCommodity(purchaseRequest.getCommodity());
            ((Investor)purchaseRequest.getBuyer()).getCommodityHoldings().add(holdingToAdd);
        }
        this.commodityBroker.getPurchaseRequests().remove(this.commodityBroker.getBuyRequestById(purchaseRequest.getPurchaseID()));
        populateBuyRequestTable();
        populateSellRequestTable();        
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(CommodityHoldings commodityHoldings:((Investor)sellRequest.getSeller()).getCommodityHoldings()){
        ...
        if(holdingToSell.getQuantity()==0){
            ((Investor)sellRequest.getSeller()).getCommodityHoldings().remove(holdingToSell);
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        seller.setBalance(seller.getBalance()-(sellRequest.getQuantity()*sellRequest.getCommodity().getCommodityPrice()));
...
if(buyRequestTable.getSelectedRow()==-1)
        ...
        CommodityPurchaseRequest buyRequest = this.commodityBroker.getBuyRequestById(Integer.parseInt(String.valueOf(buyRequestTable.getValueAt(buyRequestTable.getSelectedRow(), 0))));
        InvestorProfile buyer=buyRequest.getBuyer();
        buyer.setBalance(buyer.getBalance()+(buyRequest.getQuantity()*buyRequest.getCommodity().getCommodityPrice()));
        buyRequest.getBuyer().getCommodityPurchaseRequests().remove(buyRequest);
        this.commodityBroker.getPurchaseRequests().remove(buyRequest);
        JOptionPane.showMessageDialog(this, "Request Rejected and Deleted!");
        populateBuyRequestTable();
    ...
    private void populateCommoditiesTable() {
        ...
        for(Commodity commodity:this.business.getMarket().getCommodityMarket().getCommodityList()){
            ...
            row[2]=commodity.getUnits();
            row[3]=commodity.getCommodityPrice();
            model.addRow(row);
        }
    }
    ...
    private void populateBuyRequestTable() {
       ...
       model.setRowCount(0);
       for(CommodityPurchaseRequest commodityBuyRequest:this.commodityBroker.getPurchaseRequests()){
           Object[] row= new Object[6];
           row[0] = commodityBuyRequest.getPurchaseID();
           row[1] = commodityBuyRequest.getBuyer().getName();
           row[2] = commodityBuyRequest.getCommodity().getCommodityName();
           row[3] = commodityBuyRequest.getQuantity();
           row[4] = commodityBuyRequest.getCommodity().getUnits();
           row[5] = commodityBuyRequest.getCommodity().getCommodityPrice()*commodityBuyRequest.getQuantity();
           model.addRow(row);
       }
    }
    ...
    private void populateSellRequestTable() {
       ...
       for(CommoditySellRequest commoditySellRequest:this.commodityBroker.getSellRequests()){
           Object[] row= new Object[6];
           row[0] = commoditySellRequest.getSaleID();
           row[1] = commoditySellRequest.getSeller().getName();
           row[2] = commoditySellRequest.getCommodity().getCommodityName();
           row[3] = commoditySellRequest.getQuantity();
           row[4] = commoditySellRequest.getCommodity().getUnits();
           row[5] = commoditySellRequest.getCommodity().getCommodityPrice()*commoditySellRequest.getQuantity();
           model.addRow(row);
       }
    }
